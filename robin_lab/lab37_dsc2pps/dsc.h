...
/**
 * struct dsc_config - Parameters required to configure DSC
 *
 ...
 * format.
 */
struct dsc_picture_parameter_set {
	/**
	 * @dsc_version:
	 ...
	 * PPS24[7:4] - Reserved
	 */
	uint8_t scale_decrement_interval_high;
	/**
	 * @scale_decrement_interval_low:
	 * PPS25[7:0] - Lower 8 bits of scale decrement interval
	 */
	uint8_t scale_decrement_interval_low;
	/**
	 * @pps26_reserved:
	 * PPS26[7:0]
	 */
	uint8_t pps26_reserved;
	/**
	 * @first_line_bpg_offset:
