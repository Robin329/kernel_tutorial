...
/* Module Version: 5.7 */
/* D:\yhpsoft\Diamond\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n clk_cfg -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 120 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1  */
/* Fri Nov 27 00:51:52 2020 */


`timescale 1 ns / 1 ps
module clk_cfg (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
