 ...
 */
enum dsi_test_pattern { DSI_TEST_PATTERN_FIXED = 0, DSI_TEST_PATTERN_INC, DSI_TEST_PATTERN_POLY, DSI_TEST_PATTERN_MAX };
...
struct dsi_ctrl_hw_ops {
     ...
     */
    void (*host_setup)(struct dsi_ctrl_hw *ctrl, struct dsi_host_common_cfg *config);
     ...
     */
    void (*video_engine_setup)(struct dsi_ctrl_hw *ctrl, struct dsi_host_common_cfg *common_cfg,
     ...
     */
    void (*set_video_timing)(struct dsi_ctrl_hw *ctrl, struct dsi_mode_info *mode);
     ...
     */
    void (*cmd_engine_setup)(struct dsi_ctrl_hw *ctrl, struct dsi_host_common_cfg *common_cfg,
     ...
     */
    void (*setup_cmd_stream)(struct dsi_ctrl_hw *ctrl, struct dsi_mode_info *mode, u32 h_stride, u32 vc_id,
                             struct dsi_rect *roi);
     ...
     */
    void (*setup_lane_map)(struct dsi_ctrl_hw *ctrl, struct dsi_lane_map *lane_map);
     ...
     */
    void (*kickoff_command)(struct dsi_ctrl_hw *ctrl, struct dsi_ctrl_cmd_dma_info *cmd, u32 flags);
    ...
    void (*kickoff_command_non_embedded_mode)(struct dsi_ctrl_hw *ctrl, struct dsi_ctrl_cmd_dma_info *cmd, u32 flags);
     ...
     * transmit the command.
     */
    void (*kickoff_fifo_command)(struct dsi_ctrl_hw *ctrl, struct dsi_ctrl_cmd_dma_fifo_info *cmd, u32 flags);
     ...
     */
    u32 (*get_cmd_read_data)(struct dsi_ctrl_hw *ctrl, u8 *rd_buf, u32 read_offset, u32 rx_byte, u32 pkt_size,
                             u32 *hw_read_cnt);
     ...
     * @enable_ulps: TODO:??
     */
    void (*clamp_enable)(struct dsi_ctrl_hw *ctrl, u32 lanes, bool enable_ulps);
     ...
     */
    void (*clamp_disable)(struct dsi_ctrl_hw *ctrl, u32 lanes, bool disable_ulps);
     ...
     */
    void (*phy_reset_config)(struct dsi_ctrl_hw *ctrl, bool enable);
     ...
     */
    void (*video_test_pattern_setup)(struct dsi_ctrl_hw *ctrl, enum dsi_test_pattern type, u32 init_val);
     ...
     */
    void (*cmd_test_pattern_setup)(struct dsi_ctrl_hw *ctrl, enum dsi_test_pattern type, u32 init_val, u32 stream_id);
     ...
     */
    void (*trigger_cmd_test_pattern)(struct dsi_ctrl_hw *ctrl, u32 stream_id);
     ...
     */
    void (*setup_misr)(struct dsi_ctrl_hw *ctrl, enum dsi_op_mode panel_mode, bool enable, u32 frame_count);
     ...
     * @panel_mode:   CMD or VIDEO mode indicator
     */
    u32 (*collect_misr)(struct dsi_ctrl_hw *ctrl, enum dsi_op_mode panel_mode);
     ...
     */
    void (*set_timing_db)(struct dsi_ctrl_hw *ctrl, bool enable);
    /**
