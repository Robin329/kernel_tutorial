...
#define DSI_H_TOTAL(t) (((t)->h_active) + ((t)->h_back_porch) + ((t)->h_sync_width) + ((t)->h_front_porch))

#define DSI_V_TOTAL(t) (((t)->v_active) + ((t)->v_back_porch) + ((t)->v_sync_width) + ((t)->v_front_porch))
...
#define DSI_H_TOTAL_DSC(t)                                                          \
    ({                                                                              \
        ...
        if ((t)->dsc_enabled && (t)->dsc)                                           \
            ...
            value = (t)->h_active;                                                  \
        value = value + (t)->h_back_porch + (t)->h_sync_width + (t)->h_front_porch; \
        value;                                                                      \
    })
 ...
 * @DSI_OP_MODE_MAX:
 */
enum dsi_op_mode { DSI_OP_VIDEO_MODE = 0, DSI_OP_CMD_MODE, DSI_OP_MODE_MAX };
 ...
 */
enum dsi_cmd_set_state { DSI_CMD_SET_STATE_LP = 0, DSI_CMD_SET_STATE_HS, DSI_CMD_SET_STATE_MAX };
 ...
 * @DSI_PHY_TYPE_CPHY:
 */
enum dsi_phy_type { DSI_PHY_TYPE_DPHY, DSI_PHY_TYPE_CPHY };
 ...
 */
void dsi_rect_intersect(const struct dsi_rect *r1, const struct dsi_rect *r2, struct dsi_rect *result);
 ...
 */
static inline bool dsi_rect_is_equal(struct dsi_rect *r1, struct dsi_rect *r2) {
...
struct dsi_event_cb_info {
    ...
    int (*event_cb)(void *event_usr_ptr, uint32_t event_idx, uint32_t instance_idx, uint32_t data0, uint32_t data1,
