 ...
 *
 */
void cam_debug_log(unsigned int module_id, const char *func, const int line, const char *fmt, ...);
 ...
 * @args     :  Arguments which needs to be print in log
 */
#define CAM_DBG(__module, fmt, args...) cam_debug_log(__module, __func__, __LINE__, fmt, ##args)
