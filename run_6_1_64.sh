...
HOST_NAME=../data
ROOT=/data/workspace/BiscuitOS/output/linux-newest-arm64
...
RAM_SIZE=2048
LINUX_DIR=${ROOT}/linux/linux-6.1.64/linux-6.1.64/build/arch
...
DTB_IMAGE=${LINUX_DIR}/${ARCH}/boot/dts/qemu/virt-a710.dtb
...
# config.sh
####
_UBOOT_DIR=/home/$HOST_NAME/workspace/BiscuitOS/output/linux-newest-arm64/u-boot
